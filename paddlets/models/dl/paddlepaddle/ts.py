...
from .model.losses import hierarchical_contrastive_loss
from .model.utils import take_per_row, split_with_nan, centerize_vary_length_series, torch_pad_nan
from paddlets.datasets import TS2VecDataset
import numpy as np
...
class TS2Vec:
    ...
    def fit(self, train_data, n_epochs=None, n_iters=None, verbose=False):
        ...
        optimizer = paddle.optimizer.AdamW(parameters=self._net.parameters(), learning_rate=self.lr)
    ...
    def load(self, fn):
        ...
        self._net.load_dict(state_dict)
